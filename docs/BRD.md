...
| BR-17 | Implemented (with a disclosed residual gap) | `src/application/tools/generateReport.js`; `src/application/reporting/buildReportContent.js`; `src/adapters/docgen/{renderDocx,renderPdf,renderReportHtml}.js`; `tests/integration/reportGeneration.test.js`; `docs/adr/0004`; `docs/SECURITY.md`; issue #49 |
